...
async function runTests() {
  ...
  const test1b = Validator.validate(stringSchema, 'hi');
  ...
  const test2b = Validator.validate(emailSchema, 'notanemail');
  ...
  const test3b = Validator.validate(numberSchema, 150);
  ...
  const test4b = Validator.validate(userSchema, { name: 'J', age: -5 });
  ...
  const test5 = Validator.validateAtPath(userSchema, formData, ['name']);
